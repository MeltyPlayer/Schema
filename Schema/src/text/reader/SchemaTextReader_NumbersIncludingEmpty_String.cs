...
public sealed partial class SchemaTextReader {
  public byte?[] ReadBytesIncludingEmpty(string separators,
                                         string terminators)
    => this.ConvertSplitUpToAndPastTerminatorsIncludingEmpty_(separators,
      terminators,
      this.ConvertByte_);

  public byte?[] ReadHexBytesIncludingEmpty(string separators,
                                            string terminators)
  ...
  public sbyte?[] ReadSBytesIncludingEmpty(string separators,
                                           string terminators)
    => this.ConvertSplitUpToAndPastTerminatorsIncludingEmpty_(separators,
      terminators,
      this.ConvertSByte_);

  public sbyte?[] ReadHexSBytesIncludingEmpty(string separators,
                                              string terminators)
    => this.ConvertSplitUpToAndPastHexTerminatorsIncludingEmpty_(separators,
      terminators,
  ...
  public short?[] ReadInt16sIncludingEmpty(string separators,
                                           string terminators)
    => this.ConvertSplitUpToAndPastTerminatorsIncludingEmpty_(separators,
      terminators,
      this.ConvertInt16_);

  public short?[] ReadHexInt16sIncludingEmpty(string separators,
                                              string terminators)
    => this.ConvertSplitUpToAndPastHexTerminatorsIncludingEmpty_(separators,
      terminators,
  ...
  public ushort?[] ReadUInt16sIncludingEmpty(string separators,
                                             string terminators)
    => this.ConvertSplitUpToAndPastTerminatorsIncludingEmpty_(separators,
      terminators,
      this.ConvertUInt16_);
  ...
  public int?[] ReadInt32sIncludingEmpty(string separators,
                                         string terminators)
    => this.ConvertSplitUpToAndPastTerminatorsIncludingEmpty_(separators,
      terminators,
      this.ConvertInt32_);
  ...
  public int?[] ReadHexInt32sIncludingEmpty(string separators,
                                            string terminators)
    => this.ConvertSplitUpToAndPastHexTerminatorsIncludingEmpty_(separators,
      terminators,
      this.ConvertHexInt32_);

  public uint?[] ReadUInt32sIncludingEmpty(string separators,
                                           string terminators)
    => this.ConvertSplitUpToAndPastTerminatorsIncludingEmpty_(separators,
      terminators,
      this.ConvertUInt32_);

  public uint?[] ReadHexUInt32sIncludingEmpty(string separators,
                                              string terminators)
    => this.ConvertSplitUpToAndPastHexTerminatorsIncludingEmpty_(separators,
      terminators,
      this.ConvertHexUInt32_);

  public long?[] ReadInt64sIncludingEmpty(string separators,
                                          string terminators)
    => this.ConvertSplitUpToAndPastTerminatorsIncludingEmpty_(separators,
      terminators,
      this.ConvertInt64_);

  public long?[] ReadHexInt64sIncludingEmpty(string separators,
                                             string terminators)
    => this.ConvertSplitUpToAndPastHexTerminatorsIncludingEmpty_(separators,
      terminators,
  ...
  public ulong?[] ReadUInt64sIncludingEmpty(string separators,
                                            string terminators)
    => this.ConvertSplitUpToAndPastTerminatorsIncludingEmpty_(separators,
      terminators,
      this.ConvertUInt64_);
  ...
  public float?[] ReadSinglesIncludingEmpty(string separators,
                                            string terminators)
    => this.ConvertSplitUpToAndPastTerminatorsIncludingEmpty_(separators,
      terminators,
      this.ConvertSingle_);

  public double?[] ReadDoublesIncludingEmpty(string separators,
                                             string terminators)
    => this.ConvertSplitUpToAndPastTerminatorsIncludingEmpty_(separators,
      terminators,
      this.ConvertDouble_);
